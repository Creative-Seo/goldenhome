...
if(isset($breadcrumb2)) 
{
	...
	'/" itemprop="url"><span itemprop="title">',$breadcrumb2,'</span></a></span><span class="divider">&nbsp;<i class="fa fa-angle-right"></i>&nbsp;</span>';
}
if(isset($breadcrumb3)) 
{
	...
	'/" itemprop="url"><span itemprop="title">',$breadcrumb3,'</span></a></span><span class="divider">&nbsp;<i class="fa fa-angle-right"></i>&nbsp;</span>';
}
?>      
