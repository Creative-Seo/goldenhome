<?php $title = 'Проекты и строительство домов из пеноблоков под ключ по доступной цене';?>
<?php $description = 'Строительство домов из пеноблоков (пенобетона) под ключ. НИЗКИЕ ЦЕНЫ на строительство и проектирование. Телефон во Владимире: +7 (4922) 37-73-90, Иваново +7(4932) 92-90-99';?>
...
<div class="container">
          ...
          <p class="article">
            Дома из пеноблоков в последнее время пользуются большой популярностью. Пеноблоки обладают рядом преимуществ перед традиционными материалами строительства: высокая прочность малый вес, экологическая чистота. Мы строим дома из пеноблоков под ключ по проектам во Владимире и Иваново. Мы предлагаем строительство домов из пеноблоков по самой лучшей цене. Чтобы заказать расчет стоимости дома и составить смету, а также задать все интересующие вас вопросы, звоните по телефону +7 (4922) 37-73-90 (Владимир), +7(4932) 92-90-99 (Иваново).
          </p>
