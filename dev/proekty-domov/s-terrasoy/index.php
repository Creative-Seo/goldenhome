<?php $title = 'Проекты домов и коттеджей с террасой';?>
<?php $description = 'Проекты домов и коттеджей с террасой от компании Golden Home';?>
...
include("../proekt-04-295/block.php");?>
        ...
        <article class="article">
          <h2>Загородные дома с террасой</h2>
          <p>Проекты дома с террасой для загородной территории пользуются неизменной популярностью. Ведь терраса дарит дополнительное пространство вокруг дома, где можно наслаждаться окружающим ландшафтом и при этом находиться практически в помещении. К тому же терраса, выполненная в оригинальном стиле с различными декоративными элементами, может стать истинным украшением любого дома.</p>
          <p>Следует заметить, что терраса может быть закрытой или открытой. Открытый вариант подходит для любого здания и ее пространство ни чем не ограничивается. Такое решение обычно выбирают люди, которые любят постоянно находиться на свежем воздухе, а также любящие, чтобы солнечный свет беспрепятственно попадал в комнаты дома. Но так как такая терраса не защищает от погодных явлений, то лучше предпочесть закрытое сооружение, в котором можно будет находиться когда угодно.</p>
