<?php $title = 'Проекты двухэтажных домов и коттеджей - продажа проектов';?>
<?php $description = 'Проекты двухэтажных домов с продуманным размещением помещений - комфортны для проживания семьи любого состава. В этом разделе сайта вы сможете подобрать проект одноэтажного дома площадью от 20 до 250 кв.м., с гаражом на 1автомобиль и даже подвалом';?>
<?php $keywords = 'проекты домов, проекты коттеджей, проект дома под ключ, проекта дома под ключ цена, проекты двухэтажных домов, проекты домов из газобетона, проект строительства дома, проект двухэтажного дома';?>
<?php $breadcrumb = 'Проекты двухэтажных домов';?>
...
<?php include($root."blocks/breadcrumbs.php");?>
    <h1>Проекты двухэтажных домов – дача, коттедж, загородный дом</h1>
