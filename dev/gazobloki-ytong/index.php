<?php $title = 'Блоки Ytong (Ютонг, Итонг) купить во Владимире по доступной цене';?>
<?php $description = 'Компания Golden Home &mdash; официальный партнер Ytong во Владимире. У нас выможете купить блоки Ytong по выгодным ценам';?>
<?php $keywords = 'ytong, блоки ytong, ютонг, итонг, купить ytong, партнер ytong, пеноблоки, газосиликат';?>
...
<div class="container">
  ...
  <div class="table-responsive">
            <table width="100%" border="0" cellspacing="0" cellpadding="5" style="font-size:11px;" class="table table-striped table-hover table-bordered" itemtype="http://schema.org/ItemList" itemscope>
                ...
                <tr style="font-size:11px;background-color:#ffd400;text-align:center; font-weight:bold">
                    <td >Изображение <br /></td><td >Наименование <br /></td><td >Плотность<br /></td><td >Назначение<br /></td><td >Поверхность<br /></td><td >Длина L<br /></td><td >Ширина B <strong>&darr;</strong><br /></td><td >Высота H<br /></td><td >ед. изм.<br /></td><td  style="width: 50px ">Прочность на сжатие<br /></td><td  style="width: 50px ">Тепло- проводность<br /></td><td>Цена самовывоз<br /></td>                
                </tr>
                                                        ...
                                                        <tr itemtype="http://schema.org/Product" itemprop="itemListElement" itemscope>
                                                             <td><a href="D500-500-250/" itemprop="url"><img itemprop="image" src="img/blok-stenovoy-ytong.png" border="0" width="75" alt="блоки, D500, 625*500*250, ровные YTONG" /></a></td>
                                                                    ...
                                                                    <td>B3.5</td>
                                                                    <td>0.099</td>
                                                                    <td class="cenik" itemtype="http://schema.org/Offer" itemprop="offers" itemscope><span itemprop="price">4550</span><meta itemprop="priceCurrency" content="RUB"></span> руб.</td>
                                                             ...
                                                             <td><a href="D400-500-250/"  itemprop="url"><img  src="img/blok-stenovoy-ytong.png" border="0" width="75"  itemprop="image" alt="блоки, D400, 625*500*250, ровные YTONG" /></a></td>
                                                                    ...
                                                                    <td>B2,5</td>
                                                                    <td>0.088</td>
                                                                    <td class="cenik" itemtype="http://schema.org/Offer" itemprop="offers" itemscope><span itemprop="price">4660</span><meta itemprop="priceCurrency" content="RUB"> руб.</td>
  ...
  <p><img src="/image/bloki/ytong.jpg" alt="Блоки YTONG (Ютонг, Итонг)" class="pull-right">При возведении зданий различного назначения застройщик часто оказывается перед непростым выбором: из какого материала построить стены и межкомнатные перегородки. Сегодня на рынке представлен широчайший ассортимент строительных материалов, однако далеко не все они имеют оптимальное соотношение по качеству и цене. Не стоит также забывать и о других характеристиках, таких, как теплопроводность, прочность, звукоизоляция. Газобетон, который относится к группе ячеистых бетонов, идеально соответствует всем этим требованиям. Газобетонные блоки Ytong от компании Xella &mdash; это высокотехнологический материал, который давно пользуется заслуженной популярностью в сфере строительства.</p>
  <p>Бренд Ytong по праву можно считать маркой века &mdash; стабильно высокое качество позволило компании Xella стать лидером на рынке производства строительных материалов. История бренда Ytong началась в 1929 году: именно тогда шведская фирма Yxhult запустила первую линию по производству ячеистого бетона. Чуть позже газобетонные блоки Итонг получили свое нынешнее название и с того времени началась история бренда, которая продолжается и по сей день. Успех этого строительного материала не в последнюю очередь связан с экономическим бумом 1960-х годов в Западной Германии. Блоки Ютонг были признаны очень качественным и в то же время недорогим строительным материалом: использовать газобетон при возведении стен рекомендовал даже тогдашний министр экономики ФРГ Людвиг Эрхард.</p>
  <p>Российская история Ytong началась в 2007 году, когда компания Xella запустила свое производство газобетонных блоков в подмосковном Можайске. Ячеистый бетон к тому времени уже был известен на строительном рынке, но большая часть таких блоков (от различных производителей) не обладала высокими показателями качества. В результате компания Xella, которая является мировым лидером в сфере производства автоклавного газобетона, смогла предложить российским строителям  очень перспективный строительный материал неизменно высокого качества. О востребованности газобетона марки Ютонг говорит тот факт, что уже через два года после запуска завода в Можайске годовой объем выпуска продукции достиг 500 тысяч кубических метров.</p>

  <a name="href1"></a><h2 class="h1_small">Блоки Ytong: преимущества</h2>
  <p>Ячеистый газобетон &mdash; это материал, который отличается низкой теплопроводностью. Это свойство позволяет возводить из газобетонных блоков стены, которым не требуется дополнительное утепление, при этом стены отвечают всем современным требованиям к теплоизоляционным характеристикам. При этом при одинаковых теплоизоляционных параметрах стены из блоков Ytong имеют меньшую массу (порой в несколько раз), чем стены из других материалов. Это особенность позволяет уменьшить расходы на строительство фундамента, то же самое касается и несущих конструкций.</p>
  <p>Не менее важно и то, что стены, при возведении которых использовались блоки Ytong, имеют высокие показатели энергосбережения, а это, в свою очередь, позволяет экономить стройматериалы и в то же время увеличивает площадь внутренних помещений здания. Кроме того, компактные и легкие газобетонные блоки значительно сокращают срок работ по возведению различных объектов строительства. В некоторых случаях этот показатель может сократить срок строительства в 4 раза по сравнению с традиционными строительными материалами.</p>

  

  <a name="href2"></a><h2 class="h1_small" style="margin-top:30px;">Официальный партнер YTONG по строительству</h2>
