<?php $title = 'Стеновые блоки Bonolit 3600 руб. за м3: каталог, цены | Продажа стеновых блоков во Владимире';?>
<?php $description = 'Продажа стеновых блоков Bonolit 3600 руб. за м3 с доставкой по Владимирской области. Широкий каталог продукции';?>
...
<div class="clearfix blox">  
  <div class="col-md-4" itemtype="http://schema.org/Product" itemprop="itemListElement" itemscope>
    <div class="bloki">
     ...
     <div class="price-block center-block" itemtype="http://schema.org/Offer" itemprop="offers" itemscope><span itemprop="price">3600</span><meta itemprop="priceCurrency" content="RUB"> руб./м<sup>3</sup></div>
    </div> 
  </div>
  <div class="col-md-4" itemtype="http://schema.org/Product" itemprop="itemListElement" itemscope>
    <div class="bloki">
