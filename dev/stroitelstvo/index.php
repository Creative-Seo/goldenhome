...
<div class="container">
    ...
    <ul>
      <li>&mdash;&nbsp;строительство домов и коттеджей под ключ;</li>
      <li>&mdash;&nbsp;<a href="/proekty-domov/" target="_blank">проектирование домов</a>;</li>
      <li>&mdash;&nbsp;земляные работы;</li>
      <li>&mdash;&nbsp;<a href="/fundament/">возведение фундамента</a>;</li>
      <li>&mdash;&nbsp;монтаж кровли;</li>
      <li>&mdash;&nbsp;<a href="/gazobloki/" target="_blank">продажа газоблоков</a>;</li>
      <li>&mdash;&nbsp;<a href="/dizayn-interera/" target="_blank">дизайн интерьера</a>;</li>
    </ul>
    ...
    <ul>
      <li>&mdash;&nbsp;гарантия на все виды работ;</li>
      <li>&mdash;&nbsp;качественные и современные строительные материалы;</li>
      <li>&mdash;&nbsp;&mdash;&nbsp;строительство в соответствии с нормативной документацией и предоставляем полный пакет сопроводительных документов (проект, смету, акты, дополнительные соглашения);</li>
      <li>&mdash;&nbsp;индивидуальный подход к каждому клиенту;</li>
      <li>&mdash;&nbsp;строгое соблюдение всех условий, прописанных в договоре;</li>
      <li>&mdash;&nbsp;уверенность, что работаете с надёжной компанией;</li>
    </ul>
