<?php $title = 'Строительство коттеджа за 3 месяца';?>
<?php $description = '';?>
<?php $keywords = '';?>
...
<li><a href="img/img1.jpg" rel="jquery-lightbox" title="Строительство коттеджа за 3 месяца"><img src="img/img1s.jpg" alt="Строительство коттеджа за 3 месяца"></a></li>
  ...
  <ol>
    <li>Начнем с выбора участка под застройку. Это важное решение в проектировании, которое вам необходимо будет принять, и оно должно предшествовать остальному процессу проектирования. Неправильно выбранный участок может иметь долгосрочные отрицательные последствия, которые трудно или невозможно смягчить, как во время строительства, так и на протяжении срока жизни дома.</li>
    <li>Основа здания &mdash; это надежный фундамент. Его тип рассчитывается с учетом различных факторов: типа почвы, веса здания, особенностей рельефа. В данном случае выбран свайный с ростверком. Такая технология позволяет начать строительство даже зимой.</li>
    <li>Фундамент перекрыли сборными железобетонными плитами, выбрали материалы для стен (остановились на газобетонных блоках).</li>
    <li>Соблюдая технологии и рекомендации выполнили монолитный железобетонный пояс для распределения нагрузки от перекрытия первого этажа.</li>
    <li>Перекрытие первого этажа железобетонными плитами без внутренних несущих стен дает возможность свободной планировки.</li>
    <li>Выбор кровельного материала &mdash; прежде всего дело вкуса. Сейчас наиболее популярны металлочерепица, профнастил, битумная и композитная черепица. В данном случае предпочли металлочерепицу.</li>
