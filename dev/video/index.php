<?php $title = 'Видео-журнал «Golden Home» - видео о строительстве, дизайне';?>
<?php $description = 'Видео-журнал о дизайне «Golden Home» - видео о строительстве, дизайне, проектах домов. Интересные видео.';?>
<?php $keywords = 'Видео-журнал о дизайне';?>
<?php $breadcrumb = 'Видео-ролики';?>
...
<div class="container">
  ...
  <div class="row">
	...
	<div class="col-sm-4 col-lg-3">
        ...
        <div class="text-block">
          <span>Строительство домов будущего</span>
          <p>Уже сегодня!</p>
        </div>
    </div>
	<div class="col-sm-4 col-lg-3">
        ...
        <div class="text-block">
          <span>Выставка Ytong в Иваново (2014)</span>
          <p>Роуд-шоу YTONG в&nbsp;коттеджном поселке &laquo;Даниэль village&raquo;.</p>
        </div>
    </div>
	...
	<div class="col-sm-4 col-lg-3">
        ...
        <div class="text-block">
          <span>Обзор актуальных коттеджных поселков</span>
          <p>Обзор строящихся объектов компании Golden Home в коттеджных поселках во Владимирской области.</p>
        </div>
    </div>
	<div class="col-sm-4 col-lg-3">
        ...
        <div class="text-block">
          <span>Строительство домов из газобетона</span>
          <p>Объяснение преимуществ строительства домов из газобетона.</p>
        </div>
    </div>
	<div class="col-sm-4 col-lg-3">
        ...
        <div class="text-block">
          <span>Видео журнал, выпуск 2, кладка блоков</span>
          <p>Демонстрация технологии кладки газобетонных блоков, придуманная в компании Golden Home.</p>
        </div>
    </div>
  </div>
  ...
  <div class="row">
	<div class="col-sm-4 col-lg-3">
        ...
        <div class="text-block">
          <span>Дом в пос. Суворотское</span>
          <p> </p>
        </div>
    </div>
	<div class="col-sm-4 col-lg-3">
  ...
  <div class="row">
	...
	<div class="col-sm-4 col-lg-3">
        ...
        <div class="text-block">
          <span>Обзор современных методов освещения</span>
  ...
  <div class="row">
	<div class="col-sm-4 col-lg-3">
        ...
        <div class="text-block">
          <span><a href='http://app.talkfusion.com/newsletters/vn_view.asp?NDQxMTg5_41922905' target='_blank'>Восьмой выпуск</a></span>
          <p>Интерьер квартиры или дома &mdash; это всегда нечто индивидуальное. Он не должен нравиться всем, он должен нравиться Вам!</p>
        </div>
    </div>
	<div class="col-sm-4 col-lg-3">
        ...
        <div class="text-block">
          <span><a href='http://app.talkfusion.com/newsletters/vn_view.asp?NDE5Njk2_41922905' target='_blank'>Седьмой выпуск</a></span>
          <p>Теплоизоляция стен дома с использованием газобетонных блоков.</p>
        </div>
    </div>
	<div class="col-sm-4 col-lg-3">
        ...
        <div class="text-block">
          <span><a href='http://app.talkfusion.com/newsletters/vn_view.asp?NDEzMDE1_41922905' target='_blank'>Шестой выпуск</a></span>
          <p>Один из приёмов подчеркнуть индивидуальность современного жилища &mdash; это натяжные потолки.</p>
        </div>
    </div>
	<div class="clearfix visible-md visible-sm"></div>
	<div class="col-sm-4 col-lg-3">
        ...
        <div class="text-block">
          <span><a href='http://app.talkfusion.com/newsletters/vn_view.asp?NDA0ODQx_41922905' target='_blank'>Пятый выпуск</a></span>
          <p>Дизайн проект салона красоты и интерьера парикмахерской всегда очень сложное, но в то же время интересное задание.</p>
        </div>
    </div>
	<div class="col-sm-4 col-lg-3">
        ...
        <div class="text-block">
          <span><a href='http://app.talkfusion.com/newsletters/vn_view.asp?MzkwNzg4_40960836' target='_blank'>Четвертый выпуск</a></span>
          <p>В этом выпуске мы расскажем об остеклении коттеджей и раскроем свой секрет установки окон.</p>
        </div>
    </div>
	<div class="col-sm-4 col-lg-3">
        ...
        <div class="text-block">
          <span><a href='http://app.talkfusion.com/newsletters/vn_view.asp?Mzc5Mzcw_40960836' target='_blank'>Третий выпуск</a></span>
          <p>Камень в интерьере &mdash; это роскошь, доступная каждому!</p>
        </div>
    </div>
	<div class="clearfix visible-md visible-sm"></div>
	<div class="col-sm-4 col-lg-3">
        ...
        <div class="text-block">
          <span><a href='http://app.talkfusion.com/newsletters/vn_view.asp?MzcwMjA4_40960836' target='_blank'>Второй выпуск</a></span>
          <p>Раскрываем секреты качественной и быстрой кладки.</p>
        </div>
    </div>
	<div class="col-sm-4 col-lg-3">
        ...
        <div class="text-block">
          <span><a href='http://importantvideonewsletter.com/newsletters/vn_view.asp?MzYzNjAw_40807725' target='_blank'>Первый выпуск</a></span>
          <p>Работа дизайнера с клиентом.</p>
        </div>
	</div>
  </div>
</div>
